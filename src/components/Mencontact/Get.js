...
function Get() {
  return (
    <>
        <section id="services" className="services-area pt-120 pb-90 fix" style={{ backgroundImage: `url(${ Bg })` , backgroundRepeat: "no-repeat", backgroundPosition: "center center", backgroundAttachment: "fixed" }} >
