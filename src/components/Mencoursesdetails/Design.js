...
import One from '../../assets/img/testimonial/testi_avatar.png'
import Two from '../../assets/img/bg/cur-dt-img.png'
        ...
        <section className="project-detail">
            <div className="container">
                ...
                <div className="row">
                    ...
                    <ul className="course-meta review style2 clearfix mb-30">
                        <li className="author">
                        <div className="thumb">
                    ...
                    <div className="inner-column">
                        ...
                        litora torquet per conubia nostra, per inceptos himenaeos. Mauris
                        in erat justo. Nullam ac urna eu felis dapibus sit amet a augue.
                        Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum
                        fermentum nunc. Etiam pharetra erat sed fermentum feugiat velit
                        mauris egestas quam ut aliquam massa nisl quis neque.Sauris in
                        erat justo. Nullam ac urna eu felis dapibus sit amet a augue. Sed
                        ...
                        <strong>understand the basics</strong>, and even a small amount of
                        SEO knowledge can make a big difference.{" "}
                        <strong>Free SEO education</strong> is also widely available on
                        the web, including in guides like this! (Woohoo!) This guide is
                        designed to describe all major aspects of SEO, from finding the
                        terms and phrases (keywords) that can generate qualified traffic
                        to your website, to making your site friendly to search engines,
                        ...
                        congue semper purus. Lorem ipsum dolor sit{" "}
                        </p>
                        <p>
                        {" "}
                    ...
                    <aside className="sidebar-widget">
                        ...
                        <div className="course-widget-price">
                            ...
                            <li>
                                ...
                                <span>Starts</span>
                                <span className="time">May 29, 2016</span>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span className="time">7:00 - 9:00</span>
                            </li>
                            <li>
                            ...
                            <h5 className="pt-20 pb-20">
                            Course Price: <span>$59.00</span>
                            </h5>
                            <a className="btn ss-btn" href="#">
                            ENROLL THIS COURSE
                            </a>
                        </div>
                        </section>
