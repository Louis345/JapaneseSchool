    ...
    return (
        <>
            <header className="header-area header-three">
                <div id="header-sticky" className={`menu-area ${active && "sticky-menu"}`} >
                                            ...
                                            <ul>
                                                ...
                                                <li className="sub">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <Link to="/gallerydetail">Gallery Details</Link>
                                                        </li>
                                                        <li>
                                        ...
                                        <ul>
                                            <li>
                                                <Link to="#" className="menu-tigger" onClick={() => { setBtnshow(true) }}>
                                                    <i className="fas fa-search" onClick={() => { setBtnshow(true) }} />
                                                </Link>
                                            </li>
                                            <li>
                                                <Link to="#" className="menu-tigger" onClick={() => { setBtnshow(true) }}>
                                                    <img src={Icon} alt="logo" onClick={() => { setBtnshow(true) }} />
                                                </Link>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        {mobile &&
                                            <nav className="mean-nav">
                                                ...
                                                <li className="sub">
                                                    ...
                                                    <Link className={`mean-expand ${Pages && "mean-clicked"}`} onClick={() => { setPages(!Pages) }} to="#" style={{ fontSize: 18 }}>
                                                        {Pages ? "-" : "+"}
                                                    </Link>
                                                </li>
                                                <li className="sub">
                    ...
                    <div className={`offcanvas-menu ${"active"}`}>
                        ...
                        <div id="cssmenu3" className="menu-one-page-menu-container">
                            <ul id="menu-one-page-menu-2" className="menu">
                                ...
                                <li className="menu-item menu-item-type-custom menu-item-object-custom"><Link to="/services">Services</Link></li>
                                ...
                                <li className="menu-item menu-item-type-custom menu-item-object-custom"><Link to="/gallery">Gallery Study</Link></li>
