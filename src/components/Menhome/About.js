...
import One from '../../assets/img/features/about_img.png'

function About() {
  return (
    <>
        <section id="about" className="about-area about-p pt-70 pb-120 p-relative" style={{ background: "url(assets/img/features/about-bg-aliments.png) no-repeat",  backgroundPosition: "center center"}} >
            <div className="container">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div className="slider-btn mt-10"> 
                        <Link to="/about" className="btn ss-btn" data-animation="fadeInRight" data-delay=".8s" >
                            Read More
                        </Link>
                    </div>
                    </div>
