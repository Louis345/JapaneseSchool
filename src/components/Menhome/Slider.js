    ...
    <>
        <section id="home" className="slider-area slider-four fix p-relative">
            <div className="slider-active">
                <div className="single-slider slider-bg d-flex align-items-center" style={{ background: "url(assets/img/slider/slider_img_bg.png) no-repeat", backgroundPosition: "center center"}} >
                <div className="container">
                    ...
                    <div className="col-lg-7">
                        ...
                        <p data-animation="fadeInUp" data-delay=".6s">
                            Cras faucibus ornare ipsum, non luctus leo imperdiet sit amet.
                            Praesent egestas orci eu risus iaculis luctus. Phasellus maximus
                            orci metus.
                        </p>
                        <div className="subricbe"
                            ...
                            <button className="btn header-btn"> Subscribe Now </button>
                            </form>
                        </div>
                        </div>
                    </div>
