...
function First() {
  return (
    <>
      <section
        id="about"
        className="about-area about-p pt-120 pb-95 p-relative"
      >
            ...
            <div className="col-lg-8 col-md-12 col-sm-12 order-2">
              <div className="service-detail">
                <div className="images-box row">
                  ...
                  <div
                    className="column col-lg-8 col-md-8 col-sm-8 wow fadeInLeft"
                    style={{
                      visibility: "visible",
                  ...
                  <div className="two-column">
                    <div className="row">
                      <div className="text-column col-xl-6 col-lg-12 col-md-12">
                        <p>
                          Builds and finances utility scale solar and storage
                          projects throughout the United States. We specialize
                          in developing renewable solutions to suit the specific
                          needs of large investor owned utilities.
                        </p>
